...
public class Tools {
	...
	static ArrayList<ArrayList<Integer>> coupe(SortedSet<Integer> includedNodes, int minSize, int maxSize) {
	...
	static void recCombinaison(ArrayList<Integer> L, SortedSet<Integer> F, int minSize, int maxSize,
